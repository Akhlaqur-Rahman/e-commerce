...
//                     />
//                     <button className="bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-primary-700 transition-all">
//                       Join
//                     </button>
//                   </div>
//                 </div>
...
//                 © {new Date().getFullYear()} Lumina Shop. Powered by React & DummyJSON API.
//               </div>
//             </div>
//           </footer>
